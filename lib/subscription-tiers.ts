...
export const subscriptionTierEntitlements: TierEntitlements[] = [
  ...
  },
  {
    ...
    rbac: { kind: "text", value: "basic roles (builder, viewer)" },
  ...
  },
  {
    ...
    mcpConnections: { kind: "unlimited" },
    rbac: { kind: "text", value: "full RBAC (org_owner, agent_builder_admin, viewer, …)" },
    auditRetention: { kind: "retention_days", value: 365 },
    ssoSaml: { kind: "boolean", value: false },
    deployment: { kind: "text", value: "cloud" },
    support: { kind: "text", value: "priority" },
  },
  {
    id: "enterprise",
    monthlyPriceGbp: 499,
...
export const platformGapRegister: PlatformGap[] = [
  ...
  {
    service: "rbac",
    marketed: "Basic roles on Pro; full RBAC on Team+",
